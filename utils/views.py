...
class DisplayPlayingMediaInfo(Label):
...
class SidedMenuNavigator(BoxLayer):
    focused = None
    ...
    def __init__(self, **kwargs):
        ...
        super(SidedMenuNavigator, self).__init__(**kwargs)
    ...
    def on_touch_down(self, touch):
        if self.splitter.collide_point(*touch.pos):
            ...
            return True
        return super(SidedMenuNavigator, self).on_touch_down(touch)
...
class SidedMenuElement(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        super(SidedMenuElement, self).__init__(**kwargs)
    ...
    def on_touch_down(self, touch):
        if self.ids.head_title.collide_point(*touch.pos):
            ...
            return True
        return super(SidedMenuElement, self).on_touch_down(touch)
